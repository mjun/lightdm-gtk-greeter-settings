...
class BaseEntry(GObject.GObject):
    ...
    @GObject.Signal(arg_types=(str,), flags=GObject.SIGNAL_RUN_CLEANUP)
    def get(self, value):
        pass
...
class BooleanEntry(BaseEntry):
    ...
    def __init__(self, widgets):
        super(BooleanEntry, self).__init__(widgets)
...
class StringEntry(BaseEntry):
    ...
    def __init__(self, widgets):
        super(StringEntry, self).__init__(widgets)
        self._value = widgets['value']
...
class AdjustmentEntry(BaseEntry):
    ...
    def __init__(self, widgets):
        super(AdjustmentEntry, self).__init__(widgets)
...
class ChoiceEntry(BaseEntry):
    ...
    def __init__(self, widgets):
        super(ChoiceEntry, self).__init__(widgets)
        self._value = widgets['value']
        self._value.connect('changed', self._emit_changed)
...
class ClockFormatEntry(StringEntry):
    ...
    def __init__(self, widgets):
        super(ClockFormatEntry, self).__init__(widgets)
...
class BackgroundEntry(BaseEntry):
    ...
    def __init__(self, widgets):
        super(BackgroundEntry, self).__init__(widgets)
...
class FontEntry(BaseEntry):
    ...
    def __init__(self, widgets):
        super(FontEntry, self).__init__(widgets)
        self._value = widgets['value']
...
class IndicatorsEntry(BaseEntry):
    ...
    def __init__(self, widgets):
        super(IndicatorsEntry, self).__init__(widgets)
...
class PositionEntry(BaseEntry):
    ...
    def __init__(self, widgets):
        super(PositionEntry, self).__init__(widgets)
